...
# =========================
# MAIN APPLICATION v6 - FORCED INTERSECTION SHOTS
# =========================
def main():
    print("🎮 HYBRID FISH DETECTION SYSTEM v6.0 - FORCED INTERSECTION SHOTS")
    print("=" * 70)
    print("✨ Features:")
    ...
    try:
        while True:
            ...
            stats = [
                ...
                f"💥 Intersection Shots Fired: {intersection_shots_fired}",
                f"Motion: {motion_pct}% | Adapt: {motion_detector.base_threshold:.1f}"
            ]
            
            for i, stat in enumerate(stats):
                color = (0, 0, 255) if "FORCING ON" in stat else (255, 255, 255)
                cv2.putText(vis, stat, (10, stats_y + i*25), cv2.FONT_HERSHEY_SIMPLEX, 0.6, color, 2)
            ...
            cv2.putText(mask_display, f"Int Shots: {intersection_shots_fired}", (10, 210), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
